...
import { User, Camera, Save, Pencil, Mail, Info, Lightbulb, FileText, Download } from "lucide-react";
    ...
    <div className="space-y-6 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1">
          <Card className="border-2 border-slate-300 bg-white sticky top-6 shadow-lg">
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                <Badge className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white border-0 mb-4 px-4 py-1.5 text-sm font-semibold">
                  {profile.position || profile.role?.charAt(0).toUpperCase() + profile.role?.slice(1) || "Employee"}
                </Badge>
                <div className="w-full space-y-4 text-center mt-4">
                  ...
                  {profile.employmentType && (
                    <div className="p-3 bg-slate-50 rounded-lg">
                      <p className="text-xs text-[#64748B] mb-1 font-medium">Employment Type</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-2 border-slate-300 bg-white shadow-sm">
            ...
            <CardContent className="space-y-4 pt-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-xs font-medium text-[#64748B] mb-2 block">Position</label>
                  <p className="text-sm font-semibold text-[#0F172A] py-2">{profile.position || "N/A"}</p>
                </div>
                <div>
                  <label className="text-xs font-medium text-[#64748B] mb-2 block">Manager</label>
                  <p className="text-sm font-semibold text-[#0F172A] py-2">
                    {(profile as any).manager?.name || "N/A"}
                  </p>
                </div>
                <div>
                ...
                <div>
                  <label className="text-xs font-medium text-[#64748B] mb-2 block">Employment Type</label>
                  <p className="text-sm font-semibold text-[#0F172A] py-2 capitalize">
                    {profile.employmentType?.replace("-", " ") || "N/A"}
                  </p>
                </div>
                {profile.baseSalary && (
                  <div>
                    <label className="text-xs font-medium text-[#64748B] mb-2 block">Monthly Salary</label>
                    <p className="text-sm font-semibold text-[#0F172A] py-2">
                      Rs {profile.baseSalary.toLocaleString()}
                    </p>
                  </div>
                )}
              </div>
          ...
          <Card className="border-2 border-slate-300 bg-white shadow-sm">
            ...
            <CardContent className="space-y-4 pt-6">
              ...
              <div>
                <label className="text-xs font-medium text-[#64748B] mb-2 block">Emergency Contact</label>
                {isEditing ? (
                  <Input
                    value={formData.phone}
                    onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                  ...
                  <p className="text-sm font-semibold text-[#0F172A] py-2">
                    {(profile as any).emergencyContact || "Not provided"}
                  </p>
                )}
              </div>
            </CardContent>
