...
export default function EmployeeProfilePage() {
  ...
  const [profile, setProfile] = useState({
    ...
    joinDate: "2022-06-10",
    status: "active",
    address: "789 Employee Blvd, New York, NY 10003",
    emergencyContact: "Bob Employee - +1 (555) 765-4321",
    bio: "Passionate software developer specializing in frontend technologies and user experience design.",
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="w-full space-y-3 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-[#0F172A]">{profile.employmentType}</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border border-slate-200 bg-white">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-xs text-[#64748B] mb-1">Position</p>
                  <p className="text-sm font-semibold text-[#0F172A]">{profile.position}</p>
                </div>
                <div>
                  <p className="text-xs text-[#64748B] mb-1">Manager</p>
                  <p className="text-sm font-semibold text-[#0F172A]">{profile.manager}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-[#0F172A]">{profile.salaryType}</p>
                </div>
              </div>
            </CardContent>
          </Card>
