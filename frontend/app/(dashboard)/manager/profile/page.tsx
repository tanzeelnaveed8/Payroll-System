            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center">
                ...
                <Badge className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white border-0 mb-4 px-4 py-1.5 text-sm font-semibold">
                  {profile.role?.charAt(0).toUpperCase() + profile.role?.slice(1) || "Manager"}
                </Badge>
                <div className="w-full space-y-4 text-center mt-4">
                  ...
                  {profile.position && (
                    <div className="p-3 bg-slate-50 rounded-lg">
                      <p className="text-xs text-[#64748B] mb-1 font-medium">Position</p>
                      <p className="text-sm font-semibold text-[#0F172A]">{profile.position}</p>
                    </div>
                  )}
                </div>
              </div>
